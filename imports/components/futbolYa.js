    ...
    render() {
      return (
        <div className="container">
          ...
          ¿Ya tienes equipo? <a onClick={this.props.irACuadro} title="Haz click aqui para ir a tu reserva" className="ve">
            Ve a tu reserva <i className="fa fa-hand-o-right" /></a>
          </p>

          <a href="#laloc"><p className="baja">Para buscar o reclutar un equipo baja:
           <br />
            <i className="fa fa-sort-down" /></p></a>
        </div>
      );
    }
  }
